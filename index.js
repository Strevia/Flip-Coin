...
function onOutbreak(){
	coin.res.intelligence.amount += (0.1 * coin.res.robot.amount  * 2**coin.things.artwork.amount);
        ...
        coin.res.art.amount += Math.log2(coin.things.builder.amount) * (coin.things.enRobot.amount + 1) || 1
        coin.res.art.total += Math.log2(coin.things.builder.amount) * (coin.things.enRobot.amount + 1) || 1
